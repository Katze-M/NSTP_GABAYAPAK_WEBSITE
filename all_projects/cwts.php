<?php
// Sample CWTS projects data (will replace with DB query results)
$projects = [
    'A' => [
        [
            'id' => 1,
...
<head>
  ...
  <title>CWTS Projects - Section <?php echo $section; ?></title>
...
<body class="bg-gray-100 flex">
  ...
  <div class="mb-6 md:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div class="flex items-center space-x-2 md:space-x-4">
      ...
      <!-- Page Title -->
        <h1 class="text-xl md:text-4xl font-bold text-black">CWTS Projects - Section <?php echo $section; ?></h1>
    </div>
  </div>
    ...
    <div class="light-pink-bg p-4 md:p-6 rounded-lg">
      <div class="space-y-3 md:space-y-4">
        <?php if (!empty($currentProjects)): ?>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 bg-white rounded-lg shadow-sm gap-3">
              ...
              <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
                ...
                <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                  <a href="project_details.php?id=<?php echo $project['id']; ?>&component=CWTS" 
          ...
          <?php endforeach; ?>
        <?php else: ?>
          <p class="text-center text-gray-500 py-6 md:py-8 text-sm md:text-base">No projects found in CWTS Section <?php echo $section; ?></p>
        <?php endif; ?>
      </div>
    </div>
