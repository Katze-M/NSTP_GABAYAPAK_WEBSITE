    ...
    public function store(Request $request)
    {
        ...
        if (!$isDraft) {
            ...
            $rules = array_merge($rules, [
                ...
                // Member data - additional members are optional since project owner is automatically included
                'member_name' => 'nullable|array',
                'member_name.*' => 'required_with:member_student_id.*|string|max:255',
                'member_student_id' => 'nullable|array',
                'member_student_id.*' => 'required_with:member_name.*|integer|exists:students,id',
                'member_role' => 'nullable|array',
                'member_role.*' => 'required_with:member_student_id.*|string|max:255',
                'member_email' => 'nullable|array',
                'member_email.*' => 'required_with:member_student_id.*|email|max:255',
                'member_contact' => 'nullable|array',
                'member_contact.*' => 'required_with:member_student_id.*|string|max:20',
