...
<div class="p-6 max-w-7xl mx-auto">
    <a href="{{ route('approvals.staff') }}" class="inline-flex items-center mb-6 px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-lg transition-colors">&larr; Back to Pending Approvals</a>
    <h1 class="text-3xl font-bold mb-6 text-gray-800">Staff Approval History</h1>
