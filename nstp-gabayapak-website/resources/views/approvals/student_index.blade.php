    ...
    @else
        ...
        <div class="mt-6 flex items-center justify-between approval-pagination">
            ...
            <div class="flex items-center gap-4 approval-pagination-controls">
                {{ $pending->links() }}
                <a href="{{ route('approvals.students.history') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm whitespace-nowrap approval-history-btn">
