    ...
    <form method="POST" action="{{ route('formators.update') }}">
        ...
        <div class="bg-white rounded-2xl shadow-subtle overflow-hidden border border-gray-100">
            ...
            <div class="bg-gray-50 px-6 py-4 sm:px-8 sm:py-6 flex justify-end gap-3">
                <a href="{{ route('home') }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Cancel
                </a>
